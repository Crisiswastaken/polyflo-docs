---
title: Settings
description: Change dictation mode, the hold-to-talk hotkey, your API key, and reopen recent transcripts.
---
...
History is local to this machine. It is not synced across devices.
